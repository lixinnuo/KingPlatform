namespace Basic.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "King_loginuserkey_2017";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("King_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("King_licence", Licence.GetLicence());
        }
