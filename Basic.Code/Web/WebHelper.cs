...
namespace Basic.Code
{
    public class WebHelper
    {
        ...
        #region HtmlEncode(对html字符串进行编码)  HtmlDecode(对html字符串进行解码)
        /// <summary>
        /// 对html字符串进行编码
        /// </summary>
        ...
        /// <param name="isUpper">编码字符是否转成大写</param>
        /// <returns></returns>
        ...
        public static string HttpWebRequest(string url, string parameters, Encoding encoding, bool isPost = false, string contentType = "application/x-www-form-urlencoded", CookieContainer cookie = null, int timeout = 120000)
        {
            ...
            if (isPost)
            {
                ...
                {
                    steam.Write(postData, 0, postData.Length);
                }
            }
        ...
        #region NoHtml（去除HTML标记）
        /// <summary>
        /// 去除HTML标记
        /// </summary>
        /// <param name="Htmlstring">包含HTML的源码</param>
