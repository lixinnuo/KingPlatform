...
namespace Basic.Code
{
    public static partial class Ext
    {
        ...
        /// <summary>
        /// 获取格式化字符串，带毫秒，格式“yyyy年MM月dd日 HH时mm分”
        /// </summary>
        /// <param name="dateTime"></param>
        /// <param name="isRemoveSecond"></param>
        /// <returns></returns>
        public static string ToChineseDateString(this DateTime dateTime, bool isRemoveSecond = false)
        {
