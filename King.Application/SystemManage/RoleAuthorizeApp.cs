    ...
    public class RoleAuthorizeApp
    {
        ...
        public List<ModuleEntity> GetMenuList(string roleId)
        {
            ...
            else
            {
                ...
                var authorizadata = service.IQueryable(t => t.F_ObjectId == roleId && t.F_ItemType == 1).ToList();
                foreach (var item in authorizadata)
                {
