            ...
            endReq = function () {
                ...
                if (ts.p.unwritten) {
                    ...
                    if ($("#" + ts.p.id).find('tbody tr').length == 1) {
                        $("#" + ts.p.id).parents('.ui-jqgrid-bdiv').append('<div class="unwritten" style="position:absolute;z-index:100;width:100%;color:red;padding:7px;border-bottom:#ddd 1px solid;">没有找到您要的相关数据!</div>')
                    }
                }
            },
