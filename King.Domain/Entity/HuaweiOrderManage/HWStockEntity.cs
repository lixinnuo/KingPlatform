...
namespace King.Domain.Entity.HuaweiOrderManage
{
    ...
    public class HWStockEntity : IEntity<HWStockEntity>, ICreationAudited
    {
        ...
        public string vendorStock { get; set; }                         //供应商子库 N
        public string vendorLocation { get; set; }                      //供应商货位 N
        public string stockTime { get; set; }                           //入库时间  N       yyyy-MM-dd格式,如2017-05-16
        public string vendorItemRevision { get; set; }                  //供应商物料编码版本 N
        public string agreementStocking { get; set; }                   //是否协议备货 可以为空；非空情况下限制为Y或者N
